...
| **Wasserfall**   | **Agil**  |
|---|---|
| Der Umfang des Endprodukts kann weit im Voraus klar definiert werden | Der Umfang des Endprodukts lässt sich erst nach Gesprächen mit Nutzer:innen und Stakeholdern klären  |
...
:::tip Weiteres Material

Zur [Erfassung von Nutzer:innenbedarfe und -Feedback](wie-arbeitet-man-agil#1-nutzerinnenbedarfe-erfassen-und-verstehen)
...
Über das [Daily Standup](wie-arbeitet-man-agil#daily-standup) als Format
